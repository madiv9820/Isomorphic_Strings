...
def _make_testcase(testcase):
    ...
    def test_method(self):
        ...
        try:
            actual_output: bool = self._run_case(s=s, t=t)
        except TimeoutError:
...
class TestSolution(unittest.TestCase):
    ...
    @timeout(1)
    def _run_case(self, s: str, t: str) -> bool:
        # ⚡ Give every testcase its own timeout instead of timing the whole file.
        return self.__solution.isIsomorphic(s=s, t=t)


class IsomorphicStringsTextTestResult(unittest.TextTestResult):
    ...
    def stopTestRun(self):
        ...
        print('\n' + '🧾' + '=' * 58)
        print('📚 Isomorphic Strings Final Summary')
...
if __name__ == '__main__':
    unittest.main(
        verbosity=2,
        testRunner=unittest.TextTestRunner(resultclass=IsomorphicStringsTextTestResult)
    )